...
int main() {
    ...
    std::cout << "s1 내의 data주소 : " << static_cast<void*>(s1.data()) << std::endl;
    std::cout << "s1 의 주소 : " << static_cast<void*>(&s1) << std::endl;
    ...
    std::cout << "s3 의 주소 : " << static_cast<void*>(&s3) << std::endl;
    ...
    std::cout << "s4 의 주소 : " << static_cast<void*>(&s4) << std::endl;
    ...
    std::cout << "s2 의 주소 : " << static_cast<void*>(&s2) << std::endl;
